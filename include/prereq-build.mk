...
$(eval $(call SetupHostCommand,gcc, \
	...
	$(CC) -dumpversion | grep -E '^(4\.[8-9]|[5-9]|[1-9][0-9]+)', \
	gcc -dumpversion | grep -E '^(4\.[8-9]|[5-9]|[1-9][0-9]+)', \
...
$(eval $(call SetupHostCommand,g++, \
	...
	$(CXX) -dumpversion | grep -E '^(4\.[8-9]|[5-9]|[1-9][0-9]+)', \
	g++ -dumpversion | grep -E '^(4\.[8-9]|[5-9]|[1-9][0-9]+)', \
	g++48 --version | grep g++, \
	g++49 --version | grep g++, \
	g++5 --version | grep g++, \
	g++6 --version | grep g++, \
